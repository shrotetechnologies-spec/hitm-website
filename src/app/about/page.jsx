...
export const metadata = {
  title: 'About Al Haider College of Technology | AHCT Ranchi',
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-hitm-navy overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-7xl font-black font-serif text-white mb-6 leading-tight uppercase tracking-tighter italic">About <span className="text-hitm-gold">AHCT Ranchi</span></h1>
          <p className="text-white/70 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed font-light">
            Founded in 2008, AHCT has transformed from a local college into a premier technical institution, shaping the future of Jharkhand through excellence in Engineering and Management.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  Established as Al Haider College of Technology in 2008, our institution has emerged as a landmark of progress and education in Ranchi. We deliver a blend of theoretical knowledge and practical application that prepares students for the competitive global market.
                </p>
                <p>
                  Our 2.48-acre campus is a vibrant ecosystem where students from diverse backgrounds come together to innovate, learn, and grow. From state-of-the-art incubation centers to industry-aligned workshops, every corner of AHCT is designed for advancement.
                </p>
              </div>
